...
BigInt A;
BigInt B;
A.fromHexString("");
B.fromHexString("");
BigInt sum = A + B;
cout << "Sum in HEX: " << sum.toHexString() << endl;
BigInt diff;
diff = A - B;
cout << "A - B in HEX: " << diff.toHexString() << endl;
BigInt mult;
mult = A * B;
cout << "A * B in HEX: " << mult.toHexString() << endl;
cout << "A^2 in HEX: " << A.square().toHexString() << endl;
/*BigInt deg = A.Gor(B);
cout << "A^B Result (HEX): " << deg.toHexString() << endl;*/
BigInt frac = A / B;
BigInt rim = A % B;
cout << "Fraction (A/B): " << frac.toHexString() << endl;
cout << "Remainder (A%B): " << rim.toHexString() << endl << endl;
cout << "GCD: " << BigInt::gcd(A, B).toHexString() << endl;
cout << "LCM: " << BigInt::lcm(A, B).toHexString() << endl << endl;
BigInt N;
N.fromHexString("aa7ae6683168a693bf5f463943de0dd25f6e12ffb5e02fb337495fef83a6bd9687e48cc70cb25f3328294dbfd3601d3e4580eb0a062df6196ba923dae764818791befd11046f125b3b7eee30a7b1d8b67fa00122304623cb5203bdec121ead4d941d7b58de2e56ddf12a6ef86c1335f6f891ce5f4789965b65e5cc3d751ab75");
cout << "Sum with mod: " << A.addMod(B, N).toHexString() << endl << endl;
cout << "Diff with mod: " << A.subMod(B, N).toHexString() << endl << endl;
cout << "Mult with mod: " << A.mulMod(B, N).toHexString() << endl << endl;
BigInt gorMod = A.GorMod(B, N);
cout << "Gor with mod: " << gorMod.toHexString() << endl << endl;
